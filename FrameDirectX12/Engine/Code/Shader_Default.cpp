...
CShader_Default::CShader_Default(ID3D12Device * pGraphicDevice, ID3D12GraphicsCommandList * pCommandList)
	: CShader(pGraphicDevice, pCommandList)
{
}

CShader_Default::CShader_Default(const CShader_Default & rhs)
	: CShader(rhs)
{
...
CShader_Default::~CShader_Default()
{
}

HRESULT CShader_Default::Ready_Shader()
{
...
void CShader_Default::Begin_Shader()
{
...
HRESULT CShader_Default::Create_DescriptorHeaps()
{
...
HRESULT CShader_Default::Create_ConstantBufferView()
{
...
HRESULT CShader_Default::Create_PipelineState()
{
	vector<D3D12_INPUT_ELEMENT_DESC> vecInputLayout;

	m_pVS_ByteCode = Compile_Shader(L"../../Bin/Shader/Shader_Default.hlsl", nullptr, "VS_MAIN", "vs_5_1");
	m_pPS_ByteCode = Compile_Shader(L"../../Bin/Shader/Shader_Default.hlsl", nullptr, "PS_MAIN", "ps_5_1");
...
D3D12_RASTERIZER_DESC CShader_Default::Create_RasterizerState()
{
...
D3D12_BLEND_DESC CShader_Default::Create_BlendState()
{
...
D3D12_DEPTH_STENCIL_DESC CShader_Default::Create_DepthStencilState()
{
...
D3D12_INPUT_LAYOUT_DESC CShader_Default::Create_InputLayout()
{
	return D3D12_INPUT_LAYOUT_DESC();
}


CComponent * CShader_Default::Clone()
{
	return new CShader_Default(*this);
}

CShader_Default * CShader_Default::Create(ID3D12Device * pGraphicDevice,
	ID3D12GraphicsCommandList * pCommandList)
{
	CShader_Default* pInstance = new CShader_Default(pGraphicDevice, pCommandList);
