...
CLoadingTexture::CLoadingTexture(ID3D12Device* pGraphicDevice, ID3D12GraphicsCommandList* pCommandList)
	: Engine::CGameObject(pGraphicDevice, pCommandList)
{
}

CLoadingTexture::CLoadingTexture(const CLoadingTexture& rhs)
...
HRESULT CLoadingTexture::Ready_GameObjectPrototype()
{
...
HRESULT CLoadingTexture::Ready_GameObject()	// 복사본을 레디할 때 
{
#ifdef _DEBUG
	COUT_STR("Ready Clone LoadingTexture");
#endif
...
HRESULT CLoadingTexture::LateInit_GameObject()
{
#ifdef _DEBUG
	COUT_STR("LateInit LoadingTexture");
#endif
...
_int CLoadingTexture::LateUpdate_GameObject(const _float& fTimeDelta)
{
...
void CLoadingTexture::Render_GameObject(const _float& fTimeDelta)
{
	Set_ConstantTable();
	// 세이더 - 버퍼 - 세이더 - 버퍼 순서 중요 
...
HRESULT CLoadingTexture::Add_Component()
{
...
void CLoadingTexture::Set_ConstantTable()
{
...
CGameObject* CLoadingTexture::Clone_GameObject(void* pArg)
{
	CGameObject* pInstance = new CLoadingTexture(*this);
...
CLoadingTexture* CLoadingTexture::Create(ID3D12Device* pGraphicDevice,
	ID3D12GraphicsCommandList* pCommandList)
{
	CLoadingTexture* pInstance = new CLoadingTexture(pGraphicDevice, pCommandList);
